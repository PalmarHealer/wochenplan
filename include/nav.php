...
if ($permission_level >= $create_lessons) {
    echo '
        ...
        <div class="bottom-navbar-elements btn-box w-100 mt-4 mb-1">
            ...
            <div onclick="window.location='<?php echo $donation_link; ?>'"                          class="pointer logo-footer-div"><img src="<?php echo $relative_path; ?>/img/paypal.svg"  alt="PayPal" class="logo-footer"></div>
