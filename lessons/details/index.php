                                          ...
                                          <div class="form-group mb-3 full">
                                             <div class="card-body">
                                                ...
                                                <div class="input-group">
                                                   ...
                                                   <select name="date-repeat" class="form-control toggle_date_input1" id="type-select">
                                                ...
                                                <div class="input-group">
                                                   ...
                                                   <input name="date" type="text" class="form-control drgpicker toggle_date_input2" disabled id="date-input1" value="
                                                      <?php
