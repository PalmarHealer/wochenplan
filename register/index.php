      ...
      <div class="row align-items-center h-100">
        <form class="col-lg-6 col-md-8 col-10 mx-auto" action="?register=1<?php if (isset($_GET['token'])) { echo "&token=" . $_GET['token']; } ?>" method="post">
          <div class="mx-auto text-center my-4">
			...
			<?php if(isset($errorMessage)) { echo '<h2 class="h6 mb-3">'; echo $errorMessage; echo '</h2>'; }?>
          </div>
          ...
          <div class="form-row">
            <div class="form-group col-md-6">
              ...
              <input type="text" size="40" maxlength="250" name="vorname" id="firstname" class="form-control" value="<?php if(isset($vorname)) { echo $vorname; }?>" required>
            </div>
            <div class="form-group col-md-6">
              <label for="lastname">Nachname</label>
			  <?php if(isset($username)) { echo '<h2 class="h6 mb-3">'; echo '<br></h2>'; }?>
              <input type="text" size="40" maxlength="250" name="nachname" id="lastname" class="form-control" value="<?php if(isset($nachname)) { echo $nachname; }?>">
            </div>
          </div>
          ...
          <button class="btn btn-lg btn-primary btn-block" type="submit">Sign up</button>
            <hr>
            <h2 class="h6 mb-3 text-center">Hast du bereits ein Account?</h2>
        ...
        <div class="row align-items-center h-100">
            <form class="col-lg-3 col-md-4 col-10 mx-auto text-center">
                ...
                <div class="form-group">
                    <?php if(isset($mailempty)) { echo '<h2 class="h6 mb-3">'; echo $mailempty; echo '</h2>'; }?>
                    <?php if(isset($mailalredyused)) { echo '<h2 class="h6 mb-3">'; echo $mailalredyused; echo '</h2>'; }?>
                    <input placeholder="E-Mail-Adresse" id="email" type="email" size="40" maxlength="250" name="email" class="form-control" required>
                </div>
