  ...
  <body class="light ">
    <div class="wrapper vh-100">
      <div class="row align-items-center h-100">
        <form class="col-lg-6 col-md-8 col-10 mx-auto" action="?email=1<?php if (isset($_GET['token'])) { echo "&token=" . $_GET['token']; } ?>" method="post">
        ...
        <div class="row align-items-center h-100">
            <form class="col-lg-3 col-md-4 col-10 mx-auto text-center">
                ...
                <div class="form-group">
                    <?php if(isset($mailempty)) { echo '<h2 class="h6 mb-3">'; echo $mailempty; echo '</h2>'; }?>
                    <?php if(isset($mailalredyused)) { echo '<h2 class="h6 mb-3">'; echo $mailalredyused; echo '</h2>'; }?>
                    <input placeholder="Email address" type="email" size="40" maxlength="250" name="email" class="form-control" id="inputEmail4"" required>
                </div>
                <h2 align="center" class="h6 mb-3">Hast du bereits ein Account? dann <a href="../login">Logge dich hier ein.</a></h2>
